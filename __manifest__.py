{
    ...
    'data': [
        ...
        'views/smmonitor_views_task_analytics_date.xml',
        'views/smmonitor_views_project_task_hashtags.xml',
        'views/smmonitor_views_task_analytics_averages.xml',
        'views/smmonitor_views_project_task.xml',
        'views/smmonitor_views_project_project.xml',
        'views/smmonitor_views_project_menu_action.xml',
    ],
    'assets': {
        'web.assets_backend': [
