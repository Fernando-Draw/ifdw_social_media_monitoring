...
#############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            'ifdw_social_media_monitoring/static/src/xml/smmonitor_styles.xml',
            'ifdw_social_media_monitoring/static/src/js/timezone_detector.js',
            'ifdw_social_media_monitoring/static/src/js/analytics_views.js',
            'https://cdnjs.cloudflare.com/ajax/libs/Chart.js/3.9.1/chart.js'
        ],
        'web.assets_qweb': [
            'ifdw_social_media_monitoring/static/src/xml/analytics_views.xml',
        ],
    },
    'license': 'LGPL-3',
    'installable': True,
